...
public final class ReplyCommand extends PaperCommand {
    ...
    public ReplyCommand(CorePlugin plugin, PrivateMessageService messageService, PlayerIgnoreService ignoreService) {
        super(plugin);
    ...
    public void registerTo(@NotNull CommandManager<PaperCommandSource> commandManager) {
        commandManager.command(commandManager.commandBuilder("reply", "r")
                ...
                .handler(context -> {
                    ...
                    if (ignoreService.isIgnoredByPlayer(sender, receiver)) {
