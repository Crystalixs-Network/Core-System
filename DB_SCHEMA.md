...
![DB-Schema](assets/db_diagram_v2.jpg)
...
| `economy_transactions.from_player_id`  | `player.uuid` | Fremdschlüssel | Optionaler Sender einer Transaktion      |
| `economy_transactions.to_player_id`    | `player.uuid` | Fremdschlüssel | Optionaler Empfänger einer Transaktion   |
| `economy_transactions.actor_player_id` | `player.uuid` | Fremdschlüssel | Optionaler Akteur der Transaktion        |
