# This is a workaround because the SqlUpdater currently has a bug where /1 migration scripts are resolved from /0.
# This is a temporary fix until the bug is fixed.
# This script is identically with /1/migration.sql
